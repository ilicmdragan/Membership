            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_assoc()) {
                        echo "
					<tr>
						<td>$row[ClanstvoID]</td>
						<td>$row[DatumRazgovora]</td>	
						<td>$row[SadrzajRazgovora]</td>
						<td>$row[Agent]</td>
						<td>$row[DatumZakazanogRazgovora]</td>
						<td>
						<a class='btn btn-primary btn-sm' href='#.php?ID=$row[ClanstvoID]'>Izmeni</a>
						</td>
					</tr>
						";
                    }
